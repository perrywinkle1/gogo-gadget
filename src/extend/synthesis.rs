...
// MCP Server: {{name}}
// Purpose: {{purpose}}
// Generated by jarvis-rs self-extend
...
- This skill was auto-generated by jarvis-rs self-extend
- Created for: {{purpose}}
"#;
...
- Auto-generated by jarvis-rs self-extend
- Version: 1.0.0
"#;
...
impl SynthesisEngine {
    ...
    pub fn new(output_dir: &PathBuf) -> Self {
        Self {
            ...
            working_dir: std::env::temp_dir().join("jarvis-synthesis"),
    ...
    pub fn new_default() -> Self {
        ...
        Self {
            ...
            use_claude: true,
            claude_model: None,
            output_dir: home.join(".jarvis").join("synthesized"),
        }
    }
