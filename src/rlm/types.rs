...
pub struct RlmConfig {
    ...
    /// Model for navigation decisions (fast model like haiku)
    pub navigator_model: Option<String>,

    /// Model for chunk exploration (strong model like sonnet)
...
impl Default for RlmConfig {
    fn default() -> Self {
        Self {
            ...
            navigator_model: Some("claude-3-haiku-20240307".to_string()),
            explorer_model: None, // Use default
            use_embeddings: true,
